...
CPPFLAGS += -D__RODATA_EADK_API_LEVEL__=\"1.0\" -D__RODATA_EADK_APP_NAME__=\"Conway\"
...
.PHONY: build
build: $(BUILD_DIR)/Conway.bin

.PHONY: run
run: $(BUILD_DIR)/Conway.nwa
	@echo "INSTALL $<"
...
$(BUILD_DIR)/Conway.nwa: $(call object_for,$(src)) $(BUILD_DIR)/icon.o
	@echo "LD      $@"
